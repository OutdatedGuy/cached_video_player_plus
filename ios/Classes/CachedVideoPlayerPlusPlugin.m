#import "CachedVideoPlayerPlusPlugin.h"
...
@interface CachedVideoPlayerPlus : NSObject <FlutterTexture, FlutterStreamHandler>
...
@implementation CachedVideoPlayerPlus
...
@interface CachedVideoPlayerPlusPlugin () <CachedVideoPlayerPlusApi>
...
@implementation CachedVideoPlayerPlusPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  CachedVideoPlayerPlusPlugin* instance = [[CachedVideoPlayerPlusPlugin alloc] initWithRegistrar:registrar];
  [registrar publish:instance];
  CachedVideoPlayerPlusApiSetup(registrar.messenger, instance);
}
...
- (void)detachFromEngineForRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  for (NSNumber* textureId in _players.allKeys) {
    CachedVideoPlayerPlus* player = _players[textureId];
  ...
  // CachedVideoPlayerPlusApiSetup(registrar.messenger, nil);
}

- (CachedTextureMessage*)onPlayerSetup:(CachedVideoPlayerPlus*)player
                       frameUpdater:(CachedFrameUpdater*)frameUpdater {
...
- (CachedTextureMessage*)create:(CachedCreateMessage*)input error:(FlutterError**)error {
  ...
  if (input.asset) {
    ...
    player = [[CachedVideoPlayerPlus alloc] initWithAsset:assetPath frameUpdater:frameUpdater];
    return [self onPlayerSetup:player frameUpdater:frameUpdater];
  } else if (input.uri) {
    // player = [[CachedVideoPlayerPlus alloc] initWithURL:[NSURL URLWithString:input.uri]
    ...
    player = [[CachedVideoPlayerPlus alloc] initWithURL:usedURL
...
- (void)dispose:(CachedTextureMessage*)input error:(FlutterError**)error {
  CachedVideoPlayerPlus* player = _players[input.textureId];
